      ...
      <div style={{width:"100%",maxWidth:400,background:C.white,padding:mobile?"36px 28px":"48px 44px"}}>
        <div style={{textAlign:"center",marginBottom:32}}>
          ...
          <div style={{marginTop:16,padding:"8px 16px",background:C.black,display:"inline-block"}}>
            <span style={{...T.labelSm,color:C.white,fontSize:9}}>ADMIN PANEL</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{marginBottom:14}}>
            ...
            <input type="email" value={email} onChange={e=>setEmail(e.target.value)} placeholder="admin@alternative.ge" autoComplete="email"
