...
export const LANG_DATA = {
  en: {
    ...
    returnPolicy1:"Free cancellation before shipping — full refund guaranteed",
    returnPolicy2:"Items must be in original condition with all tags attached",
    returnPolicy3:"Refunds processed within 3–5 business days",
    returnPolicy4:"Contact us on WhatsApp to initiate a return",
  ...
  ka: {
    ...
    acceptedMethods:"მიღებული გადახდის მეთოდები",
    returnPolicy:"დაბრუნების პოლიტიკა",
    returnPolicy1:"უფასო გაუქმება გამოგზავნამდე — სრული თანხის ანაზღაურება",
    returnPolicy2:"ნივთი უნდა იყოს ორიგინალ მდგომარეობაში ტეგებით",
    returnPolicy3:"თანხის ანაზღაურება 3–5 სამუშაო დღეში",
    returnPolicy4:"დაბრუნებისთვის დაგვიკავშირდით WhatsApp-ზე",
  ...
  ru: {
    ...
    returnPolicy1:"Бесплатная отмена до отправки — полный возврат средств",
    returnPolicy2:"Товар должен быть в оригинальном состоянии с бирками",
    returnPolicy3:"Возврат средств в течение 3–5 рабочих дней",
    returnPolicy4:"Для возврата свяжитесь с нами в WhatsApp",
