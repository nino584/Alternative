      ...
      <div style={{padding:mobile?`${S.lg}px 0`:`${S.xl+4}px 0`}}>
        <div style={{maxWidth:1360,margin:"0 auto",padding:`0 ${px}`}}>
          ...
          <div style={{display:"flex",gap:S.sm,marginBottom:S.md,alignItems:"center",flexWrap:"wrap"}}>
            ...
            {[
              {alt:"Visa",svg:<svg width="42" height="14" viewBox="0 0 42 14" fill="none"><path d="M17.2.5l-4 12.5h-2.7L8.4 3.2c-.1-.5-.3-.6-.7-.8C6.6 1.9 5 1.3 3.5 1l.1-.5h4.3c.6 0 1 .4 1.1 1l1.1 5.8L13 .5h3.5l.7 0zm14.2 8.4c0-3.3-4.5-3.5-4.5-5 0-.4.4-.9 1.4-1 .7-.1 2.3-.1 3.2.5l.6-2.6c-.8-.3-1.8-.5-3-.5-3.2 0-5.4 1.7-5.4 4.1 0 1.8 1.6 2.8 2.8 3.4 1.2.6 1.6 1 1.6 1.5 0 .8-1 1.2-1.9 1.2-1.6 0-2.6-.4-3.3-.8l-.6 2.7c.8.3 2.1.6 3.6.6 3.3 0 5.5-1.6 5.5-4.1zM37.8.5c-.6 0-1.2.4-1.4 1L31.6 13h3.4l.7-1.9h4.1l.4 1.9h3l-2.6-12.5h-2.8zm.5 3.4l1 4.7h-2.7l1.7-4.7zM22.3.5L20 13h-3.2l2.3-12.5h3.2z" fill="rgba(255,255,255,0.6)"/></svg>},
              ...
              {alt:"Bank of Georgia",svg:<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M8.5 3C6.5 3 4.5 4.5 4.5 7C4.5 9 6 10.5 7.5 11L7 15.5L5.5 20H8L9 16H11.5L12.5 20H15L14 15.5C16 14.5 18 12.5 18 10C18 7 16 5 13 4C11.5 3.5 10 3 8.5 3Z" fill="rgba(243,112,33,0.7)"/><path d="M16 13C18 11 20 8 19 5.5" stroke="rgba(243,112,33,0.7)" strokeWidth="2" strokeLinecap="round" fill="none"/></svg>},
