...
const LEGAL_CONTENT = {
  ...
  terms: {
    ...
    sections: [
      ...
      {heading:"Video Verification",body:"Video Verification is an optional add-on service (€10). When selected, your item is inspected by our verification team before shipping. Photo and video materials are sent to your WhatsApp for approval. Shipping proceeds only after your confirmation."},
  ...
  returns: {
    ...
    sections: [
      ...
      {heading:"Damaged or Defective Items",body:"If your item arrives damaged or defective, contact us within 48 hours of delivery with photos of the damage. We will arrange either a full replacement or a complete refund including shipping costs."},
      {heading:"Item Not As Described",body:"If the item significantly differs from the product description or photos shown on our website, contact us within 48 hours. We will review your claim and offer a replacement or full refund."},
  ...
  shipping: {
    ...
    sections: [
      ...
      {heading:"Shipping Cost",body:"Shipping fees are included or communicated before final confirmation, depending on item size and weight. Delivery to Tbilisi is included with most orders."},
