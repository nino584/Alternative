              ...
              {isGuest&&(
                <>
                  <div style={{padding:"14px 18px",background:"rgba(177,154,122,0.05)",border:`1px solid rgba(177,154,122,0.12)`,marginBottom:24,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                    ...
                    <button onClick={()=>{setPage("auth",null,{returnAfterAuth:"checkout-bags"});}} style={{background:"none",border:"none",...T.label,color:C.tan,fontSize:11,cursor:"pointer",textDecoration:"underline"}}>{L?.signInBtn||"Sign In"}</button>
                  </div>
